<?php
    ...
    //     $name = $username;
    //     $courseid = $dao->getCourseID();
    //     $classid = $dao->getClassID();


    //     $staus = $dao->addPendingEnrolment($name, $courseid, $classid); 

    // } 

    

    //$enrollment = $dao->retrieveEnrolment($courseID, $classID);
    //echo("<script> console.log('testing: " . $enrollment . "');</script>");
