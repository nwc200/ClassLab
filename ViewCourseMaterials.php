                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <div v-for="value in nArr.length" id='drop'>
                                <a class="dropdown-item" :value="value-1" @click='test(nArr[value-1])'> {{nArr[value-1]}} - Class {{usercourses[value-1][1]}}</a>
                            </div>
                        </div>
                    </div>
        ...
        <form method='POST' action='completionProgress.php'>
            <table class="table">
                ...
                <tr class="hide1">
                    ...
                    <td>
                        <button class="btn"><i class="fa fa-download"></i>
                            <a href='<?= $url ?>' download="Lecture Notes 1.1">
                                Download Lecture Notes 1.1
                            </a>
                        </button><br>
                        <button class="btn"><i class="fa fa-download"></i>
                            <a href='<?= $url2 ?>' download="Lecture Notes 1.2">
                ...
                <tr class="hide4" <?= $hide ?>>
                    ...
                    <td>
                    <button class="btn"><i class="fa fa-download"></i>
                            <a href='<?= $url ?>' download="Lecture Notes 4.21">
